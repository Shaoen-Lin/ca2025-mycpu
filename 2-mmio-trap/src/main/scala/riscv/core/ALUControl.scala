    ...
    is(InstructionTypes.OpImm) {
      ...
      io.alu_funct := MuxLookup(io.funct3, ALUFunctions.zero)(
        Seq(
          ...
          InstructionsTypeI.sri   -> Mux(io.funct7(5) === 0.U, ALUFunctions.srl, ALUFunctions.sra)
        )
      )
    }
    ...
    is(InstructionTypes.Op) {
      ...
      io.alu_funct := MuxLookup(io.funct3, ALUFunctions.zero)(
        Seq(
          ...
          //   funct7[5] = 1 → SUB
          // TODO: Complete Mux selection logic
          InstructionsTypeR.add_sub -> Mux(io.funct7(5) === 0.U, ALUFunctions.add, ALUFunctions.sub),
          ...
          // TODO: Complete Mux selection logic
          InstructionsTypeR.sr      -> Mux(io.funct7(5) === 0.U, ALUFunctions.srl, ALUFunctions.sra)
        )
      )
    }
